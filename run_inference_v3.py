...
for epoch in range(5, 6, 1):
    ...
    for year in years:
        ...
        for name in filenames:
            ...
            dataset = InferenceDatasetV2(InferenceDatasetV2.ROOT, type=type, input_size=(252, 252))
            ...
            def evaluate():
                for idx, x in enumerate(loader):
                    ...
                    for i, row in year_specific_df.iterrows():
                        ...
                        placeholder = images[slot_start//4][:,:, y_top_left:y_bottom_right, x_top_left:x_bottom_right]
                    ...
                    with torch.amp.autocast("cuda", dtype=torch.bfloat16, enabled=True):
                        with torch.inference_mode():
                            ...
                            print('Reconstructed matrix:', reconstructed_matrix.size(), flush=True)
                ...
                for i, row in year_specific_df.iterrows():
                    ...
                    print('Sum fourth',reconstructed_matrix[i][12:16].mean(), flush=True)
                    print('------------------------------------------------------------', flush=True)
