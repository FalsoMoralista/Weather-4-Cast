...
def build_dataset(is_train, feature_extraction, test, image_folder):
...
def make_GenericDataset(
    ...
    dataset = build_dataset(is_train=training, feature_extraction=feature_extraction, test=test, image_folder=image_folder)
