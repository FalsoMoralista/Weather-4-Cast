...
def make_inference_dataset(
    ...
    logger.info("Inference Sat dataset created")
    ...
    logger.info("Inference Sat Dataset dataloader created")
...
if __name__ == "__main__":
    ...
    dataset = InferenceDataset(InferenceDataset.ROOT, type="roxi_0008.cum1test19")
