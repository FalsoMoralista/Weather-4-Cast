...
If you would like to perform a training using our architecture, you should execute the following:

```shell
sh run_main.sh CONFIG_NAME
```

From which **CONFIG_NAME** is the name of a YAML config file present in `configs` folder.
